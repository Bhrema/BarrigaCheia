    ...
    <section class="row d-flex">
        <div class="col-7 bg-image" style="background-image: url('https://www.infoans.org/images/05-Galleria-Fotografica/RMG%20-%20Querida%20Amazzonia%20-%202020/14-AMAZZONIA-04.JPG'); background-repeat: no-repeat;">
            <div class="px-4 pt-5 my-5 text-center">
                <h1 class="display-4 fw-bold text-white">Ajude-nos à ajudar!</h1>
                <div class="col-lg-6 mx-auto">
                  <p class="lead mb-4 text-white">Você tem o poder da mudança.
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-7 col-lg-8">
                  ...
                  <form class="needs-validation" novalidate="">
                    ...
                    <button class="w-100 btn btn-primary btn-lg" type="submit">Junte-se a nós</button>
                  </form>
                </div>
            </div>
    </section>
